...
const Profile = () => {
  ...
  const images = [
    {
      original:
        "https://media.distractify.com/brand-img/qjB-xhEld/2160x1131/jamal-1670255451084.jpg",
    },
    {
      original:
  ...
  return (
    <div className="volunteer-prof-overflow">
      ...
      <div className="volunteer-description-box italic-text">
        <p>
          🌟 Hi there! I'm Osama Bin Laden, your friendly neighborhood volunteer
          on a mission to make the world a better place, one smile at a time. 😊
          🌍 Earth enthusiast, 🌱 nature lover, and 🐶 pet whisperer. My
          passion? Saving the planet and spreading positive vibes wherever I go.
          🎉 When I'm not volunteering, you'll find me chasing adventures,
          exploring new places, and sipping on ☕ coffee like it's my
          superpower. 💪 I believe in the power of unity, kindness, and
          community. Let's team up, change lives, and create lasting memories
          together! Join me on this incredible journey. 🚀 #VolunteerLife
          #ChangeMaker
        </p>
      </div>
      <div>
